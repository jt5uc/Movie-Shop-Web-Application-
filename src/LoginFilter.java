...
public class LoginFilter implements Filter {
    ...
    private boolean isUrlAllowedWithoutLogin(String requestURI) {
        ...
        return requestURI.endsWith("login.html") || requestURI.endsWith("logins.js")
                || requestURI.endsWith("api/logins") ||  requestURI.endsWith("login.css")
                || requestURI.endsWith("elogin.html") || requestURI.endsWith("elogin.js")
                ||requestURI.endsWith("api/elogin");    }
